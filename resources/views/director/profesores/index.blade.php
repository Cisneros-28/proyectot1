...
@section('content')
    ...
    <div class="card-header">
        <a href="{{ route('director.profesores.create') }}" class="btn btn-primary">Nuevo Profesor</a>
    </div>
    @endif
    <br>
    <div class="card">
                ...
                <tbody>
                    ...
                    @foreach ($profesores as $profesor)
                            ...
                            <tr>
                                ...
                                <td>{{ $profesor->id }}</td>
                                <td><a href="#">{{ $profesor->nombre_user }}</a></td>
                                <td>{{ $profesor->apellido_user }}</td>
                                ...
                                <td> @if (!empty($profesor->getRoleNames()))
                                ...
                                <TD>{{$profesor->curso->nombre_curso }}</TD>
                            ...
                            <td>{{ \Carbon\Carbon::parse($profesor->created_at)->formatLocalized('%d %B %G | %R %p') }}
                            </td>
                            {{-- {{ \Carbon\Carbon::parse($date)->formatLocalized('%d %B %Y %I:%M %p') }} --}}
                            <td>
                                @if (Auth::user()->hasrole('ADMIN'))
