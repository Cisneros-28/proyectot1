            ...
            <div class="col-12 pt-3 pb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 style="text-align: center; font-family:sans-serif ">MATERIA GUARANI -U.E. CNL. CAIZA J
                            T.T.</h3>
                            <center>
                                <hr>
                                <dd class="alert alert-light" role="alert" ><img width="30px" src="<?php echo e(URL::asset('imagen/info.png')); ?>">
                                  <b>  INFORMACION</b></dd>
                                    <hr>
                            </center>
                            <dl>
                                ...
                                <dd><img width="25px" src="<?php echo e(URL::asset('imagen/studiante.png')); ?>">   Estudiante:  {{Auth::user()->nombre_user}} {{Auth::user()->apellido_user}}</dd>
@endif
                            </dl>
                            <hr>
                            <center>
                             <dd class="alert alert-light" role="alert">
                                 <img width="35px" src="<?php echo e(URL::asset('imagen/contenid.png')); ?>">  <b>CONTENIDO BLOQUE CERO</b>
                             </dd>
                            </center>
                ...
                <!--InicioDiv-->
                    ...
                    <dt>
                        @if (Auth::user()->hasrole('ESTUDIANTE'))
                            @if ($asistencia > 0)
                            <dd>
                                <a href="{{ route('estudiante.asistencias.asistencias', Auth::user()->id) }}">
                                    <h5>
                                        <img width="25px" src="<?php echo e(URL::asset('imagen/estudiantes.png')); ?>">  Asistencias
                                    </h5>
                                </a>
                            </dd>
                            @endif
...
{{-- INICIO BLOUE--}}
                                            ...
                                            <dt>
                                                <dd>
                                                    ...
                                                    @if ($tema->estado_tema == 1)
                                                        ...
                                                        @foreach ($verificar as $vvv )
                                                        @if ($vvv->verificar == 1 )
                                                        @foreach ($evaluaciones as $evaluacion)
                                                        @if ($evaluacion->estado_eval == 1)

            {{-- consultar si quiere segun la fecha de creacion OJO SI CREO LA EVALUACION EL MISMO DIA SE MOSTRARÁ CON EL MISMO DIA DE LA ASISTENCIA --}}
            @if (\Carbon\Carbon::parse($vvv->fecha)->formatLocalized('%d %B %G') ==  \Carbon\Carbon::parse($evaluacion->updated_at)->formatLocalized('%d %B %G') )


                                                            @if ($evaluacion->tema->id == $tema->id)
                                                                <dd>
                                                                    <h7>
                                                                        {{-- <a href="{{ route('estudiante.respuesta.show', $evaluacion->id) }}"> --}}
            ...
            @if ($count > 0)
                                            ...
                                            @for ($i = 0 ; $i < $tamaño; $i++)
            <?php $tamaño = $tamaño - $i; ?>
                                                @if (in_array($evaluacion->id, $respu,true))




                                                        <button id="btn" class="btn btn-sm btn-outline-primary" type="button" hidden>
                                                            Resuelto
                                                                <i class=""></i></button>

                                                @else

                                                        <!--evitar duplicado del boton-->

                                                            <a style="padding-left: 50%" href="{{ route('estudiante.respuesta.show', $evaluacion->id) }}">
                                                                <button id="btn" class="btn btn-sm btn-outline-primary" type="button"> Resolver Evaluacion
                                        ...
                                        @else
                                                    ...
                                                    <a style="padding-left: 50%" href="{{ route('estudiante.respuesta.show', $evaluacion->id) }}">
                                                        <button id="btn" class="btn btn-sm btn-outline-primary"  type="button">
                                                            Resolver Evaluacion
                                                        <i class="fa fa-arrow-circle-right"></i></button> </a>
            ...
            {{-- EN IF DE FECHA ASISTENCIA Y EVALUACION --}}
            @endif
...
<div class="row pb-3 d-print-block">
    <div class="col-12">
        <section>
            ...
            {{-- consultar si quiere segun la fecha de creacion OJO SI CREO LA EVALUACION EL MISMO DIA SE MOSTRARÁ CON EL MISMO DIA DE LA ASISTENCIA --}}
         @if (\Carbon\Carbon::parse($ppp->fecha)->formatLocalized('%d %B %G') ==  \Carbon\Carbon::parse($evaluacion->updated_at)->formatLocalized('%d %B %G') )
